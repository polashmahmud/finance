export default {
  ...
  // ========== Occasion Goals ==========
  occasionGoals: {
    title: 'Occasion Goals',
    nav: 'Goals',
    subtitle: 'Save for special occasions',
    noGoals: 'No goals yet',
    addPrompt: 'Tap + to create a new goal',
    active: 'Active',
    completed: 'Completed',
    newGoal: 'New Goal',
    editGoal: 'Edit Goal',
    ...
    contributionNotes: 'Notes (optional)',
    contributionAdded: 'Contribution added',
    deleteContribution: 'Delete Contribution',
    deleteContribConfirm: 'Are you sure you want to delete this contribution?',
    contributionDeleted: 'Contribution deleted',
    monthlySummary: 'This month, set aside',
    upcomingIn3Months: 'Upcoming in 3 months',
    typeEid: 'Eid',
    typeQurbani: 'Qurbani',
    typeBirthday: 'Birthday',
    typeAnniversary: 'Anniversary',
    typeCustom: 'Other',
    swipeHint: 'Swipe right to complete · left to delete',
