export default {
  ...
  settings: {
    ...
    localBackup: 'Upload a backup file to restore data',
    dataExport: 'Data Export',
    exportFormat: 'Choose Export Format',
    exportJson: 'JSON Backup',
    exportJsonDesc: 'Full backup, can be used to restore all data',
    exportCsv: 'CSV (Transactions)',
    exportCsvDesc: 'Transactions only, spreadsheet-friendly',
    exporting: 'Exporting…',
    exportSuccess: 'Data exported successfully',
    exportError: 'Error exporting data',
    noTransactionsToExport: 'No transactions to export',
    restoreTitle: 'Restore from Backup',
    restoreDesc: 'Select a JSON backup file (.json) to restore your data.',
    restoreSelectFile: 'Select Backup File',
    restoreConfirmTitle: 'Confirm Restore',
    restoreReplaceWarning: 'This will delete all current data and restore from the backup file. This cannot be undone.',
    restoreMergeWarning: 'Backup data will be added alongside existing data.',
    restoreMode: 'Restore Mode',
    restoreReplace: 'Replace all data',
    restoreMerge: 'Merge with existing data',
    restoring: 'Restoring…',
    restoreSuccess: 'Data restored successfully',
    restoreError: 'Error restoring data',
    invalidBackupFile: 'Invalid backup file. Please select a valid JSON backup.',
    backupFileInfo: '{transactions} transactions, {accounts} accounts, {categories} categories',
    ...
    autoBackupDesc: 'Get reminded to backup data to Google Drive',
    backupInterval: 'Reminder Interval',
    days: 'days',
    ...
    backupDueBanner: 'Backup is due! Save your data to Google Drive.',
    backupComplete: 'Backup saved to Google Drive',
    backupFailed: 'Google Drive backup failed',
    driveAuthFailed: 'Google Drive authorization failed',
    driveDisconnected: 'Google Drive disconnected',
    googleClientIdMissing: 'Google Client ID not configured. Add VITE_GOOGLE_CLIENT_ID to .env',
  },
  ...
  loans: {
    ...
    addPrompt: 'Tap + to add a new loan',
    newLoan: 'New Loan',
    newReceivable: 'New Receivable',
    newPayable: 'New Payable',
    personName: 'Person / Organization Name',
    addLoan: 'Add Loan',
    ...
    receiveBtn: 'Receive Payment',
    payBtn: 'Make Payment',
    paid: 'Paid',
    remaining: 'Remaining',
    exceedsRemaining: 'Cannot exceed remaining amount',
    ...
    deletePaymentOnly: 'Delete Only',
    deletePaymentRefund: 'Delete & Refund to Account',
    deletePaymentDeduct: 'Delete & Deduct from Account',
    paymentDeleted: 'Payment deleted',
    lentTo: 'Lent to',
    borrowedFrom: 'Borrowed from',
    loanRepayment: 'Loan Repayment (Received)',
    loanPayment: 'Loan Payment (Paid)',
    receivedFrom: 'Payment received from',
    paidTo: 'Payment made to',
    loan: 'Loan',
    newLoanEntry: 'New Loan',
    addLoanEntry: 'Add Loan',
    noLoans: 'No loans yet',
    totalLoan: 'Total Loan Remaining',
    principal: 'Principal',
    interest: 'Interest',
    interestRate: 'Interest Rate',
    validRate: 'Interest rate must be 0 or more',
    installmentCount: 'Number of Installments',
    validInstallments: 'Must have at least 1 installment',
    ...
    installmentPayment: 'Loan Installment',
    confirmInstallment: 'Confirm Installment Payment',
    confirmPay: 'Pay',
