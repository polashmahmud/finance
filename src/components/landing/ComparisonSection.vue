        ...
        <div class="comp-table">
          ...
          >
            ...
            <div class="comp-row__cell comp-row__cell--highlight">
              <check-icon v-if="row.a === true" color="#22c55e" />
...
const CrossIcon = () =>
  h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none' }, [
    h('circle', { cx: 12, cy: 12, r: 10, fill: '#ef4444', opacity: 0.1 }),
    h('path', { d: 'M15 9l-6 6M9 9l6 6', stroke: '#ef4444', 'stroke-width': 2, 'stroke-linecap': 'round', opacity: 0.6 }),
  ])
