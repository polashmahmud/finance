...
- [x] SEC-01 — Rotate Firebase credentials in Firebase Console
- [x] SEC-01 — Purge `.env` from entire git history (`git-filter-repo`)
...
_This file is excluded from git (see .gitignore). Do not commit._
